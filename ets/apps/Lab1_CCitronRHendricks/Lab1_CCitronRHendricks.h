/*****************************************************************************
*                                                                            *
*       Source title:   Lab1_CCitronRHendricks.H
...
// See Lab1_CCitronRHendricks.cpp for the implementation of this class
//
...
#define      PIN_DEFINITION( pinname, pingrpval, site0 ) \
	...
	PIN_DEFINITION (resistor, 8192 , 41)	// defines  resistor_S0
//}}AFX_ETS_PIN_DEFINITION
...
class CLab1_CCitronRHendricks : public CTestMain
{
public:
    CLab1_CCitronRHendricks(PRG_FLOW *UserFlow) : CTestMain(UserFlow) {};
    ~CLab1_CCitronRHendricks(){};
...
//  Function body in the Lab1_CCitronRHendricks.cpp file
//
